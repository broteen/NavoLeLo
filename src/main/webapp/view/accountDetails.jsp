...
<body>
	...
	<div id="content" div class="menutitle">
		<form id="accountDetails" name="accountDetails" method="post"
			action="">
			<table width="80%" border="0" align="center" cellpadding="2"
				...
				<table border=1>
					...
					<tbody id="table" align="center">
						...
						<c:forEach
							items="${user.customerDetails.accountList.transactionHistoryList}"
							var="current">
							<tr>
								<td><div align="center">
										<c:out value="${current.transactionRef" />
										</strong>
									</div></td>
								<td><div align="center">
										<c:out value="${current.transactionTime}" />
										</strong>
									</div></td>
								<td><div align="center">
										<c:out value="${current.crAccNum}" />
										</strong>
									</div></td>
								<td><div align="center">
										<c:out value="${current.drAccNum}" />
										</strong>
									</div></td>
								<td><div align="center">
